...
public class FileDrop {
				...
				public void drop(java.awt.dnd.DropTargetDropEvent evt) {
					...
					try { // Get whatever was dropped
						...
						if (tr.isDataFlavorSupported(java.awt.datatransfer.DataFlavor.javaFileListFlavor)) {
							...
							// Get a useful list
							@SuppressWarnings("unchecked") java.util.List<File> fileList = 
                                                           (java.util.List<File>) tr.getTransferData(java.awt.datatransfer.DataFlavor.javaFileListFlavor);
	...
	public static class TransferableObject implements java.awt.datatransfer.Transferable {
		 ...
		 * @since 1.1
		 */
		public TransferableObject(Object d) {
			this.data = d;
		 ...
		 * @since 1.1
		 */
		public TransferableObject(Fetcher f) {
			this.fetcher = f;
		} // end constructor
		 ...
		 * @since 1.1
		 */
		public TransferableObject(Class<?> dataClass, Fetcher f) {
			this.fetcher = f;
