...
public class PaletteEntityListener extends GridElementListener {
	...
	protected PaletteEntityListener(DiagramHandler h) {
		super(h);
	...
	private void moveDraggedEntities() {
		for (GridElement copiedEntity : copiedEntities) {
			int x = getNewCoordinate().x_loc - getOldCoordinate().x_loc;
			int y = getNewCoordinate().y_loc - getOldCoordinate().y_loc;
