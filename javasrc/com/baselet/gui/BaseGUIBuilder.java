...
public JComboBox<String> getPaletteList() {
   return paletteList;
}
...
private OwnSyntaxPane createPropertyTextPane() {
   OwnSyntaxPane ptp = new OwnSyntaxPane();
   PropertyPanelListener pListener = new PropertyPanelListener();
   ptp.getTextComponent().addKeyListener(pListener);
   ptp.getTextComponent().getDocument().addDocumentListener(pListener);
   return ptp;
}
