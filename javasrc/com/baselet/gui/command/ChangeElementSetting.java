...
public class ChangeElementSetting extends Command {
	...
	public ChangeElementSetting(String k, String value, Collection<GridElement> element) {
		this(k, createSingleValueMap(value, element));
	}

	public ChangeElementSetting(String k, Map<GridElement, String> evm) {
		this.key = k;
		this.elementValueMap = evm;
	}
