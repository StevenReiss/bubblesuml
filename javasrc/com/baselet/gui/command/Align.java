...
public class Align extends Command {
	...
	public Align(List<GridElement> ets, GridElement de, String e) {
		this.dominantEntity = de;
		this.entities = new ArrayList<GridElement>(ets);
		this.edge = Edge.valueOf(e.toUpperCase(Locale.ENGLISH));
	}
