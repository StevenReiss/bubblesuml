...
public class ClipBoard implements Transferable {
	...
	public void copyAndZoomToDefaultLevel(List<GridElement> ents, DiagramHandler handler) {
		if (ents.isEmpty()) {
			return;
		}
		...
		this.entities = new ArrayList<GridElement>(ents.size());
		DiagramHandler dhNew = new DiagramHandler(null);
		for (GridElement entitiy : ents) {
