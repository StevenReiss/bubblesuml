...
public class FormattedFont {
	...
	public FormattedFont(String stringWithFormatLabels, double fontSize, Font font, FontRenderContext frc) {
		this(StringStyle.analyzeFormatLabels(stringWithFormatLabels), fontSize, font, frc);
	}

	public FormattedFont(StringStyle text, double fontSize, Font font, FontRenderContext frc) {
		setFormat(text);
		...
		textLayout = new TextLayout(getAttributedCharacterIterator(), frc);
	}
