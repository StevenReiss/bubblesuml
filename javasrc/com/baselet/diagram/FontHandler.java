...
public class FontHandler {
	...
	public FontHandler(DiagramHandler h) {
		this.handler = h;
	}
	...
	public void setDiagramDefaultFontSize(Double sz) {
		this.diagramDefaultSize = sz;
	}
	...
	private void write(Graphics2D g2, StringStyle singleLine, double x, double y, AlignHorizontal align, boolean applyZoom) {
		...
		double fz = getFontSize(applyZoom);
		FormattedFont formattedFont = new FormattedFont(singleLine, fz, getFont(applyZoom), g2.getFontRenderContext());
