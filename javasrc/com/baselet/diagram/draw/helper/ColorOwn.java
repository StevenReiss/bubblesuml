...
public class ColorOwn {
	...
	public ColorOwn(int r, int g, int b, Transparency transparency) {
		this(r, g, b, transparency.getAlpha());
	}

	public ColorOwn(int r, int g, int b, int a) {
		this.red = r;
		this.green = g;
		this.blue = b;
		this.alpha = a;
	...
	public ColorOwn transparency(int a) {
		return new ColorOwn(getRed(), getGreen(), getBlue(), a);
	}
