...
public class TextSplitter {
	...
	private static class MinWidthCacheKey {
		...
		public MinWidthCacheKey(WordRegion[] wds, Style sty, Set<FormatLabels> fmt) {
			super();
			this.words = wds;
			this.style = sty;
			this.format = fmt;
	...
	private static class WordwrapCacheKey {
		...
		public WordwrapCacheKey(WordRegion[] wds, double w, Style sty, Set<FormatLabels> fmt) {
			super();
			this.words = wds;
			this.width = w;
			this.style = sty;
	...
	private static class WordwrapCacheValue {
		...
		public WordwrapCacheValue(StringStyle[] wl, double h) {
			super();
			this.wrappedLines = wl;
			this.height = h;
		}
    
		public WordwrapCacheValue(String[] wl, Set<FormatLabels> format, double h) {
			super();
			this.wrappedLines = new StringStyle[wl.length];
			for (int i = 0; i < wl.length; i++) {
				this.wrappedLines[i] = new StringStyle(format, wl[i]);
			}
			this.height = h;
		}
