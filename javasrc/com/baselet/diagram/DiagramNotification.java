...
public class DiagramNotification extends JComponent {
	...
	public DiagramNotification(Rectangle dps, String m, Color tc, Color bc) {
		this.message = m;
		this.drawPanelSize = dps;
		this.textColor = tc;
	...
	private String[] safeSplit(String m) {
		String[] line = m.split("\n");
		if (line.length == 0) {
			line = new String[] { m };
		}
	...
	private DimensionDouble getTextblockDimensions(String m) {
		double maxWidth = 0;
		double heightAccumulator = 0;
		for (String line : safeSplit(m)) {
