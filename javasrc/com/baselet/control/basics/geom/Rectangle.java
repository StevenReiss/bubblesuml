...
public class Rectangle {
	 ...
	 */
	public Rectangle(Double xv, Double yv, Double widthv, Double heightv) {
		this((int) Math.round(xv), (int) Math.round(yv), (int) Math.round(widthv), (int) Math.round(heightv));
	}

	public Rectangle(int xv, int yv, int widthv, int heightv) {
		this();
		setBounds(xv, yv, widthv, heightv);
	}

	public void setBounds(int xv, int yv, int widthv, int heightv) {
		this.x = xv;
		this.y = yv;
		this.width = widthv;
		this.height = heightv;
	...
	public void setWidth(int widthv) {
		this.width = widthv;
	}
	...
	public void setHeight(int heightv) {
		this.height = heightv;
	}
	...
	public void setLocation(int xv, int yv) {
		this.x = xv;
		this.y = yv;
	}

	public void setSize(int widthv, int heightv) {
		this.width = widthv;
		this.height = heightv;
	}
