...
public class CustomDrawingParserImpl extends CustomDrawingParser {
	...
	public CustomDrawingParserImpl(CustomDrawingParserTokenManager tm, double w, double h, DrawHandler dh) {
		super(tm);
		this.width = w;
		this.height = h;
		this.drawHandler = dh;
	...
	public CustomDrawingParserImpl(String dsl, double w, double h, DrawHandler dh) {
		this(new StringProvider(dsl), w, h, dh);
	}

	public CustomDrawingParserImpl(Provider stream, double w, double h, DrawHandler dh) {
		super(stream);
		this.width = w;
		this.height = h;
		this.drawHandler = dh;
