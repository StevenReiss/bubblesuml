...
public class UndoInformation {
	...
	private UndoInformation(Rectangle dr, Map<Stickable, List<PointChange>> sm, String oaa, String naa) {
		this.diffRect = dr;
		this.stickableMoves = sm;
		this.oldAdditionalAttributes = oaa;
		this.newAdditionalAttributes = naa;
	}

	public UndoInformation(Rectangle newRect, Rectangle oldRect, Map<Stickable, List<PointChange>> sm, int gridSize, String oaa, String naa) {
		this(toMinZoom(newRect.subtract(oldRect), gridSize), sm, oaa, naa);
	}
