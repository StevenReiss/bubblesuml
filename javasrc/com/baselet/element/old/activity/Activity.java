...
public class Activity extends Element {
	...
	public Activity(DiagramHandler handler, String l, Graphics2D g, String id) {
		super(handler, g, (int) (Const.PAD * handler.getZoomFactor()), id == null ? l : id);
		this.label = new Label(handler, l, g, (int) (5 * getZoom()));
	}
