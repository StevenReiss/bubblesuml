...
public class GateMessage extends Message {
	...
	private GateMessage(Lifeline f, Lifeline t, int st, String text, ArrowType at, LineType lt,
			boolean sg, boolean d) {
		super(f, t, 0, st, text, at, lt);
		this.sendGate = sg;
		this.dockToLeftBorder = d;
	}
