...
public class Lifeline {
	 ...
	 */
	public Lifeline(String t, int i, LifelineHeadType ht, boolean cos, boolean esfs) {
		super();
		this.text = t.split("\n");
		this.index = i;
		this.headType = ht;
		this.createdOnStart = cos;
		created = null;
		destroyed = null;
		this.execSpecFromStart = esfs;
	...
	public void setCreatedOnStart(boolean cos) {
		this.createdOnStart = cos;
	}
	...
	public void setCreated(Integer c) {
		this.created = c;
	}
	...
	public void setDestroyed(Integer d) {
		this.destroyed = d;
	}
	...
	public void setExecSpecFromStart(boolean fg) {
		this.execSpecFromStart = fg;
	}
	...
	private double getHeadMinWidth(DrawHandler drawHandler) {
		double minWidth = ACTOR_SIZE.x_loc; // actor width is small, so use it as minimum width
