...
public class DrawingInfoImpl implements DrawingInfo {
	...
	public DrawingInfoImpl(HorizontalDrawingInfo hd, VerticalDrawingInfo vd,
			int lifelineCount) {
		super();
		this.horizontalDrawingInfo = hd;
	...
	private class LifelineDrawingInfoProxy implements LifelineDrawingInfo {
		...
		public LifelineDrawingInfoProxy(Lifeline ll) {
			super();
			this.lifeline = ll;
		}
