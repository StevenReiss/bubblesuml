...
public class VerticalDrawingInfoImpl implements VerticalDrawingInfo {
	 ...
	 * @param allPaddings
	 */
	public VerticalDrawingInfoImpl(double sy, double sh, double dth,
			double tvp, double[] addiontalHeights, Collection<ContainerPadding> allPaddings) {
		this.startingHeadTopY = sy;
		this.startingHeadHeight = sh;
		this.tickVerticalPadding = tvp;
		this.defaultTickHeight = dth;
