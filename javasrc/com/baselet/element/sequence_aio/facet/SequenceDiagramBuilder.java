...
public class SequenceDiagramBuilder {
	...
	public void setOverrideDefaultIds(boolean fg) {
		checkState();
	...
	private static class ActiveCombinedFragment {
		public ActiveCombinedFragment(CombinedFragment cf, String cfId) {
			super();
			this.combFrag = cf;
			id = cfId;
		}
