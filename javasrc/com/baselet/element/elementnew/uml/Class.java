...
public class Class extends NewGridElement {
	...
	protected Settings createSettings() {
		return new SettingsManualResizeTop() {
			...
			protected List<Facet> createFacets() {
				return listOf(super.createFacets(), InnerClassFacet.INSTANCE, SeparatorLineWithHalignChangeFacet_local.CHANGE_INSTANCE, ActiveClassFacet.INSTANCE, TemplateClassFacet.INSTANCE);
			}
		};
	}
	...
	@Override
	protected void drawCommonContent(PropertiesParserState st) {
