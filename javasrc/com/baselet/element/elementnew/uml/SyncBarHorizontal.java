...
public class SyncBarHorizontal extends NewGridElement {
	...
	@Override
	protected void drawCommonContent(final PropertiesParserState st) {
		DrawHandler drawer = st.getDrawer();
		...
		st.setStickingPolygonGenerator(new StickingPolygonGenerator() {
			@Override
			public StickingPolygon generateStickingBorder(Rectangle rect) {
				StickingPolygon p = new StickingPolygon(rect.x, rect.y);
				double lt = st.getDrawer().getLineWidth();
