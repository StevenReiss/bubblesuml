...
public class Package extends NewGridElement {
	...
	protected void drawCommonContent(PropertiesParserState s) {
		...
		List<String> packageTitle = getTitleLines(s);
		...
		s.getBuffer().setTopMin(packageHeight);
		s.setStickingPolygonGenerator(new PointDoubleStickingPolygonGenerator(points));
	}
