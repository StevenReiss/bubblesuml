...
public abstract class AbstractPlot {
	...
	public AbstractPlot(DrawHandler d, PlotGridDrawConfig pdc, PlotState ps, int xp, int yp) {
		this.plotDrawConfig = pdc;
		this.plotState = ps;
		this.xPosition = xp;
		this.yPosition = yp;
		plot = new PlotDrawHandler(d, plotDrawConfig.getRealSize());
		setupAxis();
		setupAbstractPlot();
	}
