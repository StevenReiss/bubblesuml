...
public class AxisConfig {
	...
	public void setxIsDescription(boolean x) {
		this.xIsDescription = x;
	}
	...
	public void setDescSegment(int ds) {
		this.descSegment = ds;
	}
	...
	public void setValueSegment(Double vs) {
		this.valueSegment = vs;
	}
